...
var _user$project$Phoenix_Push$Push = F5(
	function (a, b, c, d, e) {
...
var _user$project$Phoenix_Push$init = F2(
	function (topic, event) {
		return A5(
			_user$project$Phoenix_Push$Push,
			topic,
			event,
...
var _user$project$Phoenix_Message$encode = function (_p0) {
	var _p1 = _p0;
	return A2(
		...
		_elm_lang$core$Json_Encode$object(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					{ctor: '_Tuple2', _0: 'payload', _1: _p1.payload}
				])));
};
var _user$project$Phoenix_Message$ref = F2(
	function (ref$, message) {
		return _elm_lang$core$Native_Utils.update(
			message,
			{
				ref: _elm_lang$core$Maybe$Just(ref$)
			});
	});
var _user$project$Phoenix_Message$payload = F2(
	function (payload$, message) {
		return _elm_lang$core$Native_Utils.update(
			message,
			{payload: payload$});
	});
var _user$project$Phoenix_Message$Message = F4(
	function (a, b, c, d) {
		return {topic: a, event: b, payload: c, ref: d};
	});
var _user$project$Phoenix_Message$init = F2(
	function (topic, event) {
		return A4(
			_user$project$Phoenix_Message$Message,
			topic,
			event,
			_elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$Phoenix_Message$fromPush = function (push) {
	return A2(
		_user$project$Phoenix_Message$payload,
		push.payload,
		A2(_user$project$Phoenix_Message$init, push.topic, push.event));
};
var _user$project$Phoenix_Message$decode = function (msg) {
	var decoder = A5(
...
var _user$project$Phoenix_Channel$onLeaveError = F2(
	function (onLeaveError$, chan) {
		return _elm_lang$core$Native_Utils.update(
			chan,
			{
				onLeaveError: _elm_lang$core$Maybe$Just(onLeaveError$)
			});
	});
var _user$project$Phoenix_Channel$onLeave = F2(
	function (onLeave$, chan) {
		return _elm_lang$core$Native_Utils.update(
			chan,
			{
				onLeave: _elm_lang$core$Maybe$Just(onLeave$)
			});
	});
var _user$project$Phoenix_Channel$onRejoin = F2(
	function (onRejoin$, chan) {
		return _elm_lang$core$Native_Utils.update(
			chan,
			{
				onRejoin: _elm_lang$core$Maybe$Just(onRejoin$)
			});
	});
var _user$project$Phoenix_Channel$onDisconnect = F2(
	function (onDisconnect$, chan) {
		return _elm_lang$core$Native_Utils.update(
			chan,
			{
				onDisconnect: _elm_lang$core$Maybe$Just(onDisconnect$)
			});
	});
var _user$project$Phoenix_Channel$onError = F2(
	function (onError$, chan) {
		return _elm_lang$core$Native_Utils.update(
			chan,
			{
				onError: _elm_lang$core$Maybe$Just(onError$)
			});
	});
var _user$project$Phoenix_Channel$onJoinError = F2(
	function (onJoinError$, chan) {
		return _elm_lang$core$Native_Utils.update(
			chan,
			{
				onJoinError: _elm_lang$core$Maybe$Just(onJoinError$)
			});
	});
var _user$project$Phoenix_Channel$onJoin = F2(
	function (onJoin$, chan) {
		var _p0 = chan.onRejoin;
		if (_p0.ctor === 'Nothing') {
			return _elm_lang$core$Native_Utils.update(
				chan,
				{
					onJoin: _elm_lang$core$Maybe$Just(onJoin$),
					onRejoin: _elm_lang$core$Maybe$Just(onJoin$)
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
				chan,
...
var _user$project$Phoenix_Channel$withPayload = F2(
	function (payload$, chan) {
		return _elm_lang$core$Native_Utils.update(
			chan,
			{
				payload: _elm_lang$core$Maybe$Just(payload$)
			});
	});
var _user$project$Phoenix_Channel$Channel = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {topic: a, payload: b, onJoin: c, onJoinError: d, onDisconnect: e, onError: f, onRejoin: g, onLeave: h, onLeaveError: i, on: j, debug: k, state: l};
											};
										};
									};
								};
...
var _user$project$Phoenix_Channel$Disconnected = {ctor: 'Disconnected'};
var _user$project$Phoenix_Channel$Errored = {ctor: 'Errored'};
var _user$project$Phoenix_Channel$Joined = {ctor: 'Joined'};
var _user$project$Phoenix_Channel$Joining = {ctor: 'Joining'};
var _user$project$Phoenix_Channel$Closed = {ctor: 'Closed'};
var _user$project$Phoenix_Channel$init = function (topic) {
	return {topic: topic, payload: _elm_lang$core$Maybe$Nothing, onJoin: _elm_lang$core$Maybe$Nothing, onJoinError: _elm_lang$core$Maybe$Nothing, onDisconnect: _elm_lang$core$Maybe$Nothing, onError: _elm_lang$core$Maybe$Nothing, onRejoin: _elm_lang$core$Maybe$Nothing, onLeave: _elm_lang$core$Maybe$Nothing, onLeaveError: _elm_lang$core$Maybe$Nothing, on: _elm_lang$core$Dict$empty, debug: false, state: _user$project$Phoenix_Channel$Closed};
};

var _user$project$Phoenix_Helpers_ops = _user$project$Phoenix_Helpers_ops || {};
_user$project$Phoenix_Helpers_ops['<&>'] = F2(
	function (x, f) {
		return A2(_elm_lang$core$Task$andThen, x, f);
	});
var _user$project$Phoenix_Helpers_ops = _user$project$Phoenix_Helpers_ops || {};
_user$project$Phoenix_Helpers_ops['&>'] = F2(
	function (t1, t2) {
...
var _user$project$Phoenix_Helpers$statusInfo = function (status) {
	var _p1 = status;
	switch (_p1) {
		case 'ok':
			return A2(
...
var _user$project$Phoenix_Helpers$decodeReplyPayload = function (value) {
	var result = A2(
		_elm_lang$core$Json_Decode$decodeValue,
		A2(
			_elm_lang$core$Json_Decode$andThen,
			A2(_elm_lang$core$Json_Decode_ops[':='], 'status', _elm_lang$core$Json_Decode$string),
			_user$project$Phoenix_Helpers$statusInfo),
		value);
	var _p2 = result;
	if (_p2.ctor === 'Err') {
...
var _user$project$Phoenix_Helpers$add = F2(
...
var _user$project$Phoenix_Helpers$removeIn = F3(
	function (a, b, dict) {
		var remove = function (maybeDict$) {
			var _p5 = maybeDict$;
			if (_p5.ctor === 'Nothing') {
				return _elm_lang$core$Maybe$Nothing;
			} else {
...
var _user$project$Phoenix_Helpers$insertIn = F4(
	function (a, b, value, dict) {
		var update$ = function (maybeValue) {
			var _p6 = maybeValue;
			if (_p6.ctor === 'Nothing') {
				return _elm_lang$core$Maybe$Just(
		...
		return A3(_elm_lang$core$Dict$update, a, update$, dict);
	});
var _user$project$Phoenix_Helpers$updateIn = F4(
	function (a, b, update, dict) {
		var update$ = function (maybeDict) {
			var dict$ = A3(
				_elm_lang$core$Dict$update,
				b,
				update,
				A2(_elm_lang$core$Maybe$withDefault, _elm_lang$core$Dict$empty, maybeDict));
			return _elm_lang$core$Dict$isEmpty(dict$) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(dict$);
		};
		return A3(_elm_lang$core$Dict$update, a, update$, dict);
	});
var _user$project$Phoenix_Helpers$getIn = F3(
	function (a, b, dict) {
		return A2(
...
var _user$project$Phoenix_ChannelHelpers$updateOn = F2(
	function (on, channel) {
		return _elm_lang$core$Native_Utils.update(
			channel,
			{on: on});
	});
var _user$project$Phoenix_ChannelHelpers$updatePayload = F2(
	function (payload, channel) {
		return _elm_lang$core$Native_Utils.update(
			channel,
			{payload: payload});
	});
var _user$project$Phoenix_ChannelHelpers$updateState = F2(
		...
		if (channel.debug) {
			var _p0 = A2(
				...
				A2(
					...
					'Channel \"',
					A2(_elm_lang$core$Basics_ops['++'], channel.topic, '\"')),
				state);
			return _elm_lang$core$Native_Utils.update(
				channel,
				{state: state});
...
var _user$project$Phoenix_ChannelHelpers$insertState = F4(
	function (endpoint, topic, state, dict) {
		var update = _elm_lang$core$Maybe$map(
			_user$project$Phoenix_ChannelHelpers$updateState(state));
		return A4(_user$project$Phoenix_Helpers$updateIn, endpoint, topic, update, dict);
	});
var _user$project$Phoenix_ChannelHelpers$get = F3(
	function (endpoint, topic, channelsDict) {
		return A3(_user$project$Phoenix_Helpers$getIn, endpoint, topic, channelsDict);
	});
var _user$project$Phoenix_ChannelHelpers$getState = F3(
	function (endpoint, topic, channelsDict) {
		return A2(
			...
			A3(_user$project$Phoenix_ChannelHelpers$get, endpoint, topic, channelsDict));
	});
var _user$project$Phoenix_ChannelHelpers$leaveMessage = function (_p3) {
	var _p4 = _p3;
	return A2(_user$project$Phoenix_Message$init, _p4.topic, 'phx_leave');
};
var _user$project$Phoenix_ChannelHelpers$joinMessage = function (_p5) {
	var _p6 = _p5;
	var base = A2(_user$project$Phoenix_Message$init, _p6.topic, 'phx_join');
	var _p7 = _p6.payload;
	if (_p7.ctor === 'Nothing') {
		return base;
	} else {
		return A2(_user$project$Phoenix_Message$payload, _p7._0, base);
	}
};
var _user$project$Phoenix_ChannelHelpers$map = F2(
	function (func, chan) {
		var f = _elm_lang$core$Maybe$map(
			F2(
				function (x, y) {
...
var _user$project$Phoenix_Socket$Socket = F7(
	function (a, b, c, d, e, f, g) {
		return {endpoint: a, params: b, heartbeatIntervall: c, withoutHeartbeat: d, connection: e, reconnectTimer: f, debug: g};
	});
var _user$project$Phoenix_Socket$Connected = F2(
	function (a, b) {
		return {ctor: 'Connected', _0: a, _1: b};
	});
var _user$project$Phoenix_Socket$Opening = F2(
	function (a, b) {
		return {ctor: 'Opening', _0: a, _1: b};
	});
var _user$project$Phoenix_Socket$Closed = {ctor: 'Closed'};
var _user$project$Phoenix_Socket$init = function (endpoint) {
	return {
		endpoint: endpoint,
		params: _elm_lang$core$Native_List.fromArray(
			[]),
		heartbeatIntervall: 30 * _elm_lang$core$Time$second,
		withoutHeartbeat: false,
		connection: _user$project$Phoenix_Socket$Closed,
		reconnectTimer: _user$project$Phoenix_Socket$defaultReconnectTimer,
		debug: false
	};
};

var _user$project$Phoenix_SocketHelpers$debugLogMessage = F2(
	function (socket, msg) {
		return socket.debug ? A2(_elm_lang$core$Debug$log, 'Received', msg) : msg;
	});
var _user$project$Phoenix_SocketHelpers$ref = function (socket) {
	var _p0 = socket.connection;
...
var _user$project$Phoenix_SocketHelpers$get = F2(
	function (endpoint, dict) {
		return A2(_elm_lang$core$Dict$get, endpoint, dict);
	});
var _user$project$Phoenix_SocketHelpers$getRef = F2(
	function (endpoint, dict) {
		return A2(
			_elm_lang$core$Maybe$andThen,
			A2(_user$project$Phoenix_SocketHelpers$get, endpoint, dict),
			_user$project$Phoenix_SocketHelpers$ref);
	});
var _user$project$Phoenix_SocketHelpers$close = function (_p1) {
	var _p2 = _p1;
	var _p3 = _p2.connection;
	switch (_p3.ctor) {
		case 'Opening':
			return _elm_lang$core$Process$kill(_p3._1);
		case 'Connected':
			return _elm_lang$websocket$WebSocket_LowLevel$close(_p3._0);
		default:
			return _elm_lang$core$Task$succeed(
				{ctor: '_Tuple0'});
	}
};
var _user$project$Phoenix_SocketHelpers$after = function (backoff) {
...
var _user$project$Phoenix_SocketHelpers$open = F2(
	function (socket, settings) {
		var query = A2(
			...
			A2(
				...
				socket.params));
		var endpoint = socket.endpoint;
		var url = A2(_elm_lang$core$String$contains, '?', endpoint) ? A2(
			_elm_lang$core$Basics_ops['++'],
			endpoint,
...
var _user$project$Phoenix_SocketHelpers$push = F2(
	function (message, socket) {
		var _p6 = socket.connection;
		if (_p6.ctor === 'Connected') {
			var _p9 = _p6._1;
			var message$ = socket.debug ? A2(
				_elm_lang$core$Debug$log,
				'Send',
				A2(_user$project$Phoenix_Message$ref, _p9, message)) : A2(_user$project$Phoenix_Message$ref, _p9, message);
			return A2(
				_elm_lang$core$Task$map,
				function (maybeBadSend) {
					var _p7 = maybeBadSend;
					if (_p7.ctor === 'Nothing') {
						return _elm_lang$core$Maybe$Just(_p9);
					} else {
						if (socket.debug) {
							var _p8 = A2(_elm_lang$core$Debug$log, 'BadSend', _p7._0);
							return _elm_lang$core$Maybe$Nothing;
						} else {
							return _elm_lang$core$Maybe$Nothing;
						}
				...
				A2(
					...
					_p6._0,
					_user$project$Phoenix_Message$encode(message$)));
		} else {
			return _elm_lang$core$Task$succeed(_elm_lang$core$Maybe$Nothing);
		}
	});
var _user$project$Phoenix_SocketHelpers$updateParams = F2(
	function (params, socket) {
		return _elm_lang$core$Native_Utils.update(
			socket,
			{params: params});
	});
var _user$project$Phoenix_SocketHelpers$increaseRef = function (socket) {
	var _p10 = socket.connection;
	if (_p10.ctor === 'Connected') {
		return _elm_lang$core$Native_Utils.update(
			socket,
			{
				connection: A2(_user$project$Phoenix_Socket$Connected, _p10._0, _p10._1 + 1)
			});
	} else {
		return socket;
	}
};
var _user$project$Phoenix_SocketHelpers$connected = F2(
	function (ws, socket) {
		return _elm_lang$core$Native_Utils.update(
			socket,
			{
				connection: A2(_user$project$Phoenix_Socket$Connected, ws, 0)
			});
	});
var _user$project$Phoenix_SocketHelpers$opening = F3(
	function (backoff, pid, socket) {
		return _elm_lang$core$Native_Utils.update(
			socket,
			{
				connection: A2(_user$project$Phoenix_Socket$Opening, backoff, pid)
			});
	});
...
var _user$project$Phoenix$heartbeatMessage = A2(_user$project$Phoenix_Message$init, 'phoenix', 'heartbeat');
	...
	function (router, endpoint, state) {
		...
		if (_p0.ctor === 'Nothing') {
			...
			var updateChannel = F2(
				function (_p1, channel) {
					...
					if (_p2.ctor === 'Errored') {
						...
						return A2(_user$project$Phoenix_ChannelHelpers$updateState, _user$project$Phoenix_Channel$Disconnected, channel);
					}
				});
			var updatedEndpointChannels = A2(_elm_lang$core$Dict$map, updateChannel, _p6);
			var notifyApp = function (channel) {
				var _p3 = channel.state;
				if (_p3.ctor === 'Joined') {
					var _p4 = channel.onDisconnect;
					if (_p4.ctor === 'Nothing') {
						return _elm_lang$core$Task$succeed(
							{ctor: '_Tuple0'});
					} else {
						return A2(_elm_lang$core$Platform$sendToApp, router, _p4._0);
					}
				} else {
					return _elm_lang$core$Task$succeed(
						{ctor: '_Tuple0'});
			...
			var notify = A3(
				_elm_lang$core$Dict$foldl,
				F3(
					function (_p5, channel, task) {
						return A2(
							_user$project$Phoenix_Helpers_ops['&>'],
							task,
							notifyApp(channel));
					}),
...
var _user$project$Phoenix$getEventCb = F3(
	function (endpoint, message, channels) {
		var _p7 = A3(_user$project$Phoenix_Helpers$getIn, endpoint, message.topic, channels);
		if (_p7.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			return A2(_elm_lang$core$Dict$get, message.event, _p7._0.on);
		}
	});
var _user$project$Phoenix$dispatchMessage = F4(
	function (router, endpoint, message, channels) {
		var _p8 = A3(_user$project$Phoenix$getEventCb, endpoint, message, channels);
		if (_p8.ctor === 'Nothing') {
			return _elm_lang$core$Task$succeed(
				{ctor: '_Tuple0'});
		} else {
...
var _user$project$Phoenix$handleSelfcallback = F4(
	function (router, endpoint, message, selfCallbacks) {
		...
		if (_p9.ctor === 'Nothing') {
			...
			var _p11 = _p9._0;
			var _p10 = A2(_elm_lang$core$Dict$get, _p11, selfCallbacks);
	...
	function (ref, maybeSelfCb, state) {
		...
		if (_p12.ctor === 'Nothing') {
			...
			return _elm_lang$core$Native_Utils.update(
				state,
				{
					selfCallbacks: A3(_elm_lang$core$Dict$insert, ref, _p12._0, state.selfCallbacks)
				});
		}
	});
...
var _user$project$Phoenix$pushSocket$ = F4(
	function (endpoint, message, maybeSelfCb, state) {
		var _p13 = A2(_elm_lang$core$Dict$get, endpoint, state.sockets);
		if (_p13.ctor === 'Nothing') {
			...
			return A2(
				_user$project$Phoenix_Helpers_ops['<&>'],
				A2(_user$project$Phoenix_SocketHelpers$push, message, _p15),
				function (maybeRef) {
					var _p14 = maybeRef;
						...
						return _elm_lang$core$Task$succeed(
							A3(
								...
								A3(
									...
									endpoint,
									_user$project$Phoenix_SocketHelpers$increaseRef(_p15),
									state)));
					}
				});
		}
	...
	function (endpoint, message, selfCb, state) {
		var queuedState = _elm_lang$core$Task$succeed(
			_elm_lang$core$Native_Utils.update(
				...
				{
					channelQueues: A4(
						_user$project$Phoenix_Helpers$updateIn,
						endpoint,
						message.topic,
						_user$project$Phoenix_Helpers$add(
					...
					return _elm_lang$core$Task$succeed(
						A3(
							...
							A3(
								_user$project$Phoenix$insertSocket,
								endpoint,
								_user$project$Phoenix_SocketHelpers$increaseRef(socket),
								state)));
				}
			});
		var _p17 = A2(_elm_lang$core$Dict$get, endpoint, state.sockets);
		if (_p17.ctor === 'Nothing') {
			return queuedState;
		} else {
			var _p20 = _p17._0;
			var _p18 = A3(_user$project$Phoenix_ChannelHelpers$get, endpoint, message.topic, state.channels);
			if (_p18.ctor === 'Nothing') {
				return queuedState;
			} else {
				var _p19 = _p18._0.state;
				if (_p19.ctor === 'Joined') {
					return A2(
						_user$project$Phoenix_Helpers_ops['<&>'],
						A2(_user$project$Phoenix_SocketHelpers$push, message, _p20),
						afterSocketPush(_p20));
				} else {
					return queuedState;
				}
			}
...
var _user$project$Phoenix$processQueue = F3(
	function (endpoint, messages, state) {
		...
		if (_p21.ctor === '[]') {
			...
			return A2(
				_user$project$Phoenix_Helpers_ops['<&>'],
				A4(_user$project$Phoenix$pushSocket, endpoint, _p21._0._0, _p21._0._1, state),
				A2(_user$project$Phoenix$processQueue, endpoint, _p21._1));
		}
	});
var _user$project$Phoenix$removeChannelQueue = F3(
	function (endpoint, topic, state) {
		return _elm_lang$core$Native_Utils.update(
			state,
			{
				channelQueues: A3(_user$project$Phoenix_Helpers$removeIn, endpoint, topic, state.channelQueues)
			});
	});
...
var _user$project$Phoenix$buildChannelsDict = F2(
	function (subs, dict) {
		...
		if (_p22.ctor === '[]') {
			...
			var build = F2(
				function (channel, dict$) {
					return A2(
						_user$project$Phoenix$buildChannelsDict,
						_p22._1,
						A4(_user$project$Phoenix_Helpers$insertIn, _p22._0._0.endpoint, channel.topic, channel, dict$));
				});
			return A3(_elm_lang$core$List$foldl, build, dict, _p22._0._1);
		}
	});
var _user$project$Phoenix$buildSocketsDict = function (subs) {
	var insert = F2(
		function (sub, dict) {
			var _p23 = sub;
			var _p24 = _p23._0;
			return A3(_elm_lang$core$Dict$insert, _p24.endpoint, _p24, dict);
		});
...
var _user$project$Phoenix$subMap = F2(
	function (func, sub) {
		...
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$Phoenix_ChannelHelpers$map(func),
				_p25._1));
	});
...
var _user$project$Phoenix$push = F2(
	function (endpoint, push$) {
		return _user$project$Phoenix$command(
			A2(_user$project$Phoenix$Send, endpoint, push$));
	});
var _user$project$Phoenix$cmdMap = F2(
	function (func, cmd) {
		...
		return A2(
			...
			_p26._0,
			A2(_user$project$Phoenix_Push$map, func, _p26._1));
	});
...
var _user$project$Phoenix$sendPushsHelp = F2(
	function (cmds, state) {
		...
		if (_p27.ctor === '[]') {
			...
			var _p28 = _p27._0._1;
			var message = _user$project$Phoenix_Message$fromPush(_p28);
			return A2(
				_user$project$Phoenix_Helpers_ops['<&>'],
				A4(
					...
					_elm_lang$core$Maybe$Just(
						_user$project$Phoenix$PushResponse(_p28)),
					state),
				_user$project$Phoenix$sendPushsHelp(_p27._1));
		}
	});
...
var _user$project$Phoenix$heartbeat = F3(
	function (router, endpoint, state) {
		var _p29 = A2(_elm_lang$core$Dict$get, endpoint, state.sockets);
		if (_p29.ctor === 'Just') {
			var _p30 = _p29._0;
			return _p30.withoutHeartbeat ? _elm_lang$core$Task$succeed(state) : A2(
				_user$project$Phoenix_Helpers_ops['&>'],
				_elm_lang$core$Process$spawn(
					A2(
						_user$project$Phoenix_Helpers_ops['&>'],
						_elm_lang$core$Process$sleep(_p30.heartbeatIntervall),
						A2(
							_elm_lang$core$Platform$sendToSelf,
							router,
							_user$project$Phoenix$SendHeartbeat(endpoint)))),
				A4(_user$project$Phoenix$pushSocket$, endpoint, _user$project$Phoenix$heartbeatMessage, _elm_lang$core$Maybe$Nothing, state));
		} else {
			return _elm_lang$core$Task$succeed(state);
		}
	});
...
var _user$project$Phoenix$handleChannelJoinReply = F6(
	function (router, endpoint, topic, message, prevState, channels) {
		var newChannels = function (state) {
			return _elm_lang$core$Task$succeed(
				A4(_user$project$Phoenix_ChannelHelpers$insertState, endpoint, topic, state, channels));
		};
		var handlePayload = F2(
			function (channel, payload) {
				var _p31 = payload;
				if (_p31.ctor === 'Err') {
					var _p32 = channel.onJoinError;
					if (_p32.ctor === 'Nothing') {
						return newChannels(_user$project$Phoenix_Channel$Errored);
					} else {
						return A2(
							_user$project$Phoenix_Helpers_ops['&>'],
							A2(
								...
								router,
								_p32._0(_p31._0)),
							newChannels(_user$project$Phoenix_Channel$Errored));
					}
				} else {
					var _p36 = _p31._0;
					var join = A2(
						...
						newChannels(_user$project$Phoenix_Channel$Joined));
					var _p33 = prevState;
					if (_p33.ctor === 'Disconnected') {
						var _p34 = channel.onRejoin;
		...
		var maybePayload = _user$project$Phoenix_Helpers$decodeReplyPayload(message.payload);
		var maybeChannel = A3(_user$project$Phoenix_ChannelHelpers$get, endpoint, topic, channels);
		return A2(
			_elm_lang$core$Maybe$withDefault,
...
var _user$project$Phoenix$sendJoinHelper = F3(
	function (endpoint, channels, state) {
		...
		if (_p37.ctor === '[]') {
			...
			var _p38 = _p37._0;
			var newChannel = A2(_user$project$Phoenix_ChannelHelpers$updateState, _user$project$Phoenix_Channel$Joining, _p38);
			var newChannels = A4(_user$project$Phoenix_Helpers$insertIn, endpoint, _p38.topic, newChannel, state.channels);
			var message = _user$project$Phoenix_ChannelHelpers$joinMessage(_p38);
			var selfCb = A3(_user$project$Phoenix$ChannelJoinReply, endpoint, _p38.topic, _p38.state);
			return A2(
				_user$project$Phoenix_Helpers_ops['<&>'],
				A4(
					_user$project$Phoenix$pushSocket$,
				...
				function (newState) {
					return A3(_user$project$Phoenix$sendJoinHelper, endpoint, _p37._1, newState);
				});
		}
	});
var _user$project$Phoenix$handlePhoenixMessage = F4(
	function (router, endpoint, message, state) {
		var _p39 = message.event;
		switch (_p39) {
			case 'phx_error':
				var _p40 = A3(_user$project$Phoenix_Helpers$getIn, endpoint, message.topic, state.channels);
				if (_p40.ctor === 'Nothing') {
					return _elm_lang$core$Task$succeed(state);
				} else {
					var _p42 = _p40._0;
					var sendToApp = function () {
						var _p41 = _p42.onError;
						if (_p41.ctor === 'Nothing') {
							return _elm_lang$core$Task$succeed(
								{ctor: '_Tuple0'});
						} else {
							return A2(_elm_lang$core$Platform$sendToApp, router, _p41._0);
						}
					}();
					var newChannel = A2(_user$project$Phoenix_ChannelHelpers$updateState, _user$project$Phoenix_Channel$Errored, _p42);
					return A2(
						_user$project$Phoenix_Helpers_ops['&>'],
						sendToApp,
						A3(
...
var _user$project$Phoenix$rejoinAllChannels = F2(
	function (endpoint, state) {
		var _p43 = A2(_elm_lang$core$Dict$get, endpoint, state.channels);
...
var _user$project$Phoenix$sendLeaveChannel = F3(
	function (router, endpoint, channel) {
		var _p44 = channel.state;
		if (_p44.ctor === 'Joined') {
			return A2(
				_elm_lang$core$Platform$sendToSelf,
				router,
				A2(_user$project$Phoenix$LeaveChannel, endpoint, channel));
		} else {
			return _elm_lang$core$Task$succeed(
				{ctor: '_Tuple0'});
		}
...
var _user$project$Phoenix$sendJoinChannel = F3(
	function (router, endpoint, channel) {
		return A2(
			_elm_lang$core$Platform$sendToSelf,
			router,
			A2(_user$project$Phoenix$JoinChannel, endpoint, channel));
	});
	...
	function (router, endpoint, definedChannels, stateChannels) {
		...
		var bothStep = F4(
			function (topic, defined, state, getNewChannels) {
				var channel = A2(
					_user$project$Phoenix_ChannelHelpers$updateOn,
					defined.on,
					A2(_user$project$Phoenix_ChannelHelpers$updatePayload, defined.payload, state));
				return A2(
					_elm_lang$core$Task$map,
...
var _user$project$Phoenix$handleChannelsUpdate = F3(
	function (router, definedChannels, stateChannels) {
		var rightStep = F3(
			function (endpoint, stateEndpointChannels, getNewChannels) {
				...
				return A2(_user$project$Phoenix_Helpers_ops['&>'], sendLeave, getNewChannels);
			});
		var bothStep = F4(
		...
		var leftStep = F3(
			function (endpoint, definedEndpointChannels, getNewChannels) {
				...
				return A2(
					_user$project$Phoenix_Helpers_ops['<&>'],
					A2(_user$project$Phoenix_Helpers_ops['&>'], sendJoin, getNewChannels),
					insert);
			});
		return A6(
			_elm_lang$core$Dict$merge,
...
var _user$project$Phoenix$open = F2(
	function (socket, router) {
		var onMessage = F2(
			function (_p45, msg) {
				var _p46 = _user$project$Phoenix_Message$decode(msg);
				if (_p46.ctor === 'Ok') {
					return A2(
						_elm_lang$core$Platform$sendToSelf,
						router,
						A2(
							...
							socket.endpoint,
							A2(_user$project$Phoenix_SocketHelpers$debugLogMessage, socket, _p46._0)));
				} else {
					return _elm_lang$core$Task$succeed(
						{ctor: '_Tuple0'});
				}
		...
		return A2(
			_user$project$Phoenix_SocketHelpers$open,
			socket,
			{
				onMessage: onMessage,
				onClose: function (details) {
					return A2(
						_elm_lang$core$Platform$sendToSelf,
						router,
						A2(_user$project$Phoenix$Die, socket.endpoint, details));
				}
			});
	});
var _user$project$Phoenix$attemptOpen = F3(
	function (router, backoff, socket) {
		var badOpen = function (details) {
			return A2(
				_elm_lang$core$Platform$sendToSelf,
				router,
				A2(_user$project$Phoenix$BadOpen, socket.endpoint, details));
		};
		var goodOpen = function (ws) {
			return A2(
				_elm_lang$core$Platform$sendToSelf,
				router,
				A2(_user$project$Phoenix$GoodOpen, socket.endpoint, ws));
		};
		var actuallyAttemptOpen = A2(
			_elm_lang$core$Task$onError,
			A2(
				_elm_lang$core$Task$andThen,
				A2(_user$project$Phoenix$open, socket, router),
				goodOpen),
			badOpen);
...
var _user$project$Phoenix$handleSocketsUpdate = F3(
	function (router, definedSockets, stateSockets) {
		var rightStep = F3(
			function (endpoint, stateSocket, getNewSockets) {
				return A2(
					_user$project$Phoenix_Helpers_ops['&>'],
					_user$project$Phoenix_SocketHelpers$close(stateSocket),
					getNewSockets);
			});
		var bothStep = F4(
			function (endpoint, definedSocket, stateSocket, getNewSockets) {
				return A2(
					_elm_lang$core$Task$map,
					A2(
						_elm_lang$core$Dict$insert,
						endpoint,
						A2(_user$project$Phoenix_SocketHelpers$updateParams, definedSocket.params, stateSocket)),
					getNewSockets);
			});
		var leftStep = F3(
			function (endpoint, definedSocket, getNewSockets) {
				return A2(
					_user$project$Phoenix_Helpers_ops['<&>'],
					getNewSockets,
					function (newSockets) {
						return A2(
							_user$project$Phoenix_Helpers_ops['<&>'],
							A3(_user$project$Phoenix$attemptOpen, router, 0, definedSocket),
							function (pid) {
								return _elm_lang$core$Task$succeed(
									A3(
										_elm_lang$core$Dict$insert,
										endpoint,
										A3(_user$project$Phoenix_SocketHelpers$opening, 0, pid, definedSocket),
										newSockets));
							});
					});
			});
	...
	function (router, selfMsg, state) {
		...
		switch (_p47.ctor) {
			case 'GoodOpen':
				var _p52 = _p47._1;
				var _p51 = _p47._0;
				var _p48 = A2(_user$project$Phoenix_SocketHelpers$get, _p51, state.sockets);
				if (_p48.ctor === 'Just') {
					var _p50 = _p48._0;
					var state$ = A3(
						_user$project$Phoenix$insertSocket,
						_p51,
						A2(_user$project$Phoenix_SocketHelpers$connected, _p52, _p50),
						state);
					var _p49 = _p50.debug ? A2(_elm_lang$core$Debug$log, 'WebSocket connected with ', _p51) : _p51;
					return A2(
						_user$project$Phoenix_Helpers_ops['<&>'],
						A3(_user$project$Phoenix$heartbeat, router, _p51, state$),
						function (newState) {
							return A2(_user$project$Phoenix$rejoinAllChannels, _p51, newState);
						});
				} else {
					var socket = A2(
						_user$project$Phoenix_SocketHelpers$connected,
						_p52,
						_user$project$Phoenix_Socket$init(_p51));
					return A2(
						_user$project$Phoenix_Helpers_ops['&>'],
						A2(
							_elm_lang$core$Platform$sendToSelf,
							router,
							A2(_user$project$Phoenix$GoodOpen, _p51, _p52)),
						_elm_lang$core$Task$succeed(
							A3(_user$project$Phoenix$updateSocket, _p51, socket, state)));
				}
			case 'BadOpen':
				var _p58 = _p47._0;
				var _p57 = _p47._1;
				var _p53 = A2(_elm_lang$core$Dict$get, _p58, state.sockets);
				if (_p53.ctor === 'Nothing') {
					return _elm_lang$core$Task$succeed(state);
				} else {
					var _p56 = _p53._0;
					var backoffIteration = function () {
						var _p54 = _p56.connection;
						if (_p54.ctor === 'Opening') {
							return _p54._0 + 1;
						} else {
							return 0;
						}
					}();
					var backoff = _p56.reconnectTimer(backoffIteration);
					var newState = function (pid) {
						return A3(
							_user$project$Phoenix$updateSocket,
							_p58,
							A3(_user$project$Phoenix_SocketHelpers$opening, backoffIteration, pid, _p56),
							state);
					};
					var _p55 = _p56.debug ? A2(
						_elm_lang$core$Debug$log,
						A2(_elm_lang$core$Basics_ops['++'], 'WebSocket couldn\'t connect with ', _p58),
						_p57) : _p57;
					return A2(
						_elm_lang$core$Task$map,
						newState,
						A3(_user$project$Phoenix$attemptOpen, router, backoff, _p56));
				}
			case 'Die':
				var _p62 = _p47._0;
				var _p59 = A2(_elm_lang$core$Dict$get, _p62, state.sockets);
				if (_p59.ctor === 'Nothing') {
					return _elm_lang$core$Task$succeed(state);
				} else {
					var _p61 = _p59._0;
					var getNewState = A3(_user$project$Phoenix$handleChannelDisconnect, router, _p62, state);
					var backoffIteration = function () {
						var _p60 = _p61.connection;
						if (_p60.ctor === 'Opening') {
							return _p60._0 + 1;
						} else {
							return 0;
						}
					}();
					var backoff = _p61.reconnectTimer(backoffIteration);
					var finalNewState = function (pid) {
						return A2(
							...
							A2(
								_user$project$Phoenix$updateSocket,
								_p62,
								A3(_user$project$Phoenix_SocketHelpers$opening, backoffIteration, pid, _p61)),
							getNewState);
					};
					return A2(
						_elm_lang$core$Task$andThen,
						A3(_user$project$Phoenix$attemptOpen, router, backoff, _p61),
						finalNewState);
				}
			case 'Receive':
				var _p64 = _p47._1;
				...
				return A2(
					...
					A2(
						_user$project$Phoenix_Helpers_ops['&>'],
						A4(_user$project$Phoenix$dispatchMessage, router, _p63, _p64, state.channels),
						A2(
							_elm_lang$core$Task$map,
							function (selfCbs) {
								return A2(_user$project$Phoenix$updateSelfCallbacks, selfCbs, state);
							},
							A4(_user$project$Phoenix$handleSelfcallback, router, _p63, _p64, state.selfCallbacks))),
					A3(_user$project$Phoenix$handlePhoenixMessage, router, _p63, _p64));
			case 'ChannelJoinReply':
				return A2(
					...
					A6(_user$project$Phoenix$handleChannelJoinReply, router, _p47._0, _p47._1, _p47._3, _p47._2, state.channels));
			case 'JoinChannel':
				var _p68 = _p47._0;
				var _p67 = _p47._1;
				var _p65 = A2(_elm_lang$core$Dict$get, _p68, state.sockets);
				if (_p65.ctor === 'Nothing') {
					return _elm_lang$core$Task$succeed(state);
				} else {
					var _p66 = _p65._0.connection;
					if (_p66.ctor === 'Connected') {
						return A4(
							_user$project$Phoenix$pushSocket$,
							_p68,
							_user$project$Phoenix_ChannelHelpers$joinMessage(_p67),
							_elm_lang$core$Maybe$Just(
								A3(_user$project$Phoenix$ChannelJoinReply, _p68, _p67.topic, _p67.state)),
							state);
					} else {
						return _elm_lang$core$Task$succeed(state);
					}
			...
			case 'LeaveChannel':
				var _p72 = _p47._0;
				var _p71 = _p47._1;
				var _p69 = A2(_elm_lang$core$Dict$get, _p72, state.sockets);
				if (_p69.ctor === 'Nothing') {
					...
					if (_p70.ctor === 'Joined') {
						return A4(
							_user$project$Phoenix$pushSocket$,
							_p72,
							_user$project$Phoenix_ChannelHelpers$leaveMessage(_p71),
							_elm_lang$core$Maybe$Just(
								A2(_user$project$Phoenix$ChannelLeaveReply, _p72, _p71)),
							state);
					} else {
						return _elm_lang$core$Task$succeed(state);
					}
			...
			case 'ChannelLeaveReply':
				var _p77 = _p47._1;
				var _p73 = _user$project$Phoenix_Helpers$decodeReplyPayload(_p47._2.payload);
				if (_p73.ctor === 'Nothing') {
					return _elm_lang$core$Task$succeed(state);
				} else {
					var _p74 = _p73._0;
					if (_p74.ctor === 'Err') {
						var _p75 = _p77.onLeaveError;
			...
			case 'SendHeartbeat':
				return A3(_user$project$Phoenix$heartbeat, router, _p47._0, state);
			case 'GoodJoin':
				var _p80 = _p47._1;
				var _p79 = _p47._0;
				var _p78 = A3(_user$project$Phoenix_Helpers$getIn, _p79, _p80, state.channelQueues);
				if (_p78.ctor === 'Nothing') {
					return _elm_lang$core$Task$succeed(state);
				} else {
					return A2(
						_elm_lang$core$Task$map,
						A2(_user$project$Phoenix$removeChannelQueue, _p79, _p80),
						A3(_user$project$Phoenix$processQueue, _p79, _p78._0, state));
				}
			case 'PushResponse':
				var _p85 = _p47._0;
				var _p81 = _user$project$Phoenix_Helpers$decodeReplyPayload(_p47._1.payload);
				if (_p81.ctor === 'Nothing') {
					return _elm_lang$core$Task$succeed(state);
				} else {
					var _p82 = _p81._0;
					if (_p82.ctor === 'Err') {
						var _p83 = _p85.onError;
...
var _user$project$Chat$chatMessage = function (msg) {
	...
	if (_p0.ctor === 'Message') {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('chat-message')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('chat-message-user-name')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('chat-message-message')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(_p0._0.message)
						]))
				]));
	} else {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('user-joined')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('user-name')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(_p0._0)
						])),
					_elm_lang$html$Html$text(' joined (open another tab to join with another user)')
				]));
	}
};
var _user$project$Chat$chatMessages = function (messages) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('chat-messages')
			]),
...
var _user$project$Chat$socket = _user$project$Phoenix_Socket$init(_user$project$Chat$lobbySocket);
var _user$project$Chat$Model = F5(
	function (a, b, c, d, e) {
		return {userName: a, userNameTaken: b, state: c, messages: d, composedMessage: e};
	});
...
var _user$project$Chat$UserJoined = function (a) {
	return {ctor: 'UserJoined', _0: a};
};
var _user$project$Chat$decodeUserJoinedMsg = A2(
	_elm_lang$core$Json_Decode$object1,
	_user$project$Chat$UserJoined,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'user_name', _elm_lang$core$Json_Decode$string));
		...
		switch (_p1.ctor) {
			case 'UpdateUserName':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{userName: _p1._0, userNameTaken: false}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'UpdateState':
				return A2(
			...
			case 'UserNameTaken':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{userNameTaken: true, state: _user$project$Chat$LeftLobby}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			...
			case 'SendComposedMessage':
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_user$project$Phoenix$push, _user$project$Chat$lobbySocket, push)
						]));
			case 'NewMsg':
				var _p2 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Chat$decodeNewMsg, _p1._0);
				if (_p2.ctor === 'Ok') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
			...
			default:
				var _p3 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Chat$decodeUserJoinedMsg, _p1._0);
				if (_p3.ctor === 'Ok') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
...
var _user$project$Chat$UserJoinedMsg = function (a) {
	return {ctor: 'UserJoinedMsg', _0: a};
};
...
var _user$project$Chat$composeMessage = function (_p4) {
	var _p5 = _p4;
	var cannotSend = function () {
		var _p6 = _p5.state;
		if (_p6.ctor === 'JoinedLobby') {
			return false;
		} else {
			return true;
		}
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('send-form'),
				_elm_lang$html$Html_Events$onSubmit(_user$project$Chat$SendComposedMessage)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('send-input'),
						_elm_lang$html$Html_Attributes$value(_p5.composedMessage),
						_elm_lang$html$Html_Events$onInput(_user$project$Chat$UpdateComposedMessage)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('send-button'),
						_elm_lang$html$Html_Attributes$disabled(cannotSend)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
		...
		return _elm_lang$html$Html_Attributes$classList(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					{ctor: '_Tuple2', _0: 'button-disabled', _1: disabled}
				]));
	};
	var _p7 = model.state;
	switch (_p7.ctor) {
		case 'LeavingLobby':
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Leaving lobby...')
					]));
		case 'LeftLobby':
			return A2(
				_elm_lang$html$Html$button,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Join lobby')
					]));
		case 'JoiningLobby':
			return A2(
				_elm_lang$html$Html$button,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Joning lobby...')
					]));
		default:
			return A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						buttonClass(false),
						_elm_lang$html$Html_Events$onClick(
						_user$project$Chat$UpdateState(_user$project$Chat$LeavingLobby))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Leave lobby')
					]));
	}
};
var _user$project$Chat$UserNameTaken = {ctor: 'UserNameTaken'};
var _user$project$Chat$lobby = function (userName) {
	return _user$project$Phoenix_Channel$withDebug(
		A3(
			...
			'user_joined',
			_user$project$Chat$UserJoinedMsg,
			A3(
				_user$project$Phoenix_Channel$on,
				'new_msg',
				_user$project$Chat$NewMsg,
				A2(
					...
					A2(
						_user$project$Phoenix_Channel$onJoinError,
						function (_p9) {
							return _user$project$Chat$UserNameTaken;
						},
						A2(
	...
	switch (_p11.ctor) {
		case 'JoiningLobby':
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Chat$lobby(model.userName)
					]));
		case 'JoinedLobby':
			return A2(
				_user$project$Phoenix$connect,
...
var _user$project$Chat$enterLeaveLobby = function (model) {
	var error = model.userNameTaken ? A2(
		_elm_lang$html$Html$span,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('User name already taken')
			])) : A2(
		_elm_lang$html$Html$span,
		_elm_lang$core$Native_List.fromArray(
			[]),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('enter-lobby')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('user-name-input'),
								_elm_lang$html$Html_Attributes$disabled(inputDisabled),
								_elm_lang$html$Html_Attributes$value(model.userName),
								_elm_lang$html$Html_Events$onInput(_user$project$Chat$UpdateUserName)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						error
					])),
				_user$project$Chat$button(model)
			]));
};
var _user$project$Chat$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Chat$enterLeaveLobby(model),
				_user$project$Chat$chatMessages(model.messages),
				_user$project$Chat$composeMessage(model)
			]));
};
